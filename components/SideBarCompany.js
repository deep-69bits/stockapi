                                    ...
                                    <div key={year} className='my-5'>
                                        ...
                                        <ul>
                                            {transcripts.map((item, it) => (
                                                <Link key={it} href={'/company/' + code + "?earning=" + item.transcriptid} className={ item.transcriptid==id?"flex justify-between items-center cursor-pointer opacity-100 hover:opacity-100 text-[12px] py-2":'flex hover:opacity-100 justify-between items-center cursor-pointer opacity-50 text-[12px] py-2 '}>
                                                    <span>
